...
export async function POST(req) {
    try {
        ...
        if (process.env.ORBIT_ALLOW_V01_WRAP !== "1") {
            return Response.json({ error: "V01_WRAP_DISABLED" }, { status: 501 });
        }
        ...
        return Response.json({ error: "ANYTIME_V02_FAILED", message: String(e?.message ?? e) }, { status: 500 });
    }
}
