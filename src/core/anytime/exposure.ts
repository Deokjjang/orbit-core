...
export type AudienceV02 = z.infer<typeof AudienceV02>;

export const StakesV02 = z.enum(["low", "high"]);
export type StakesV02 = z.infer<typeof StakesV02>;
...
export type ExposurePolicyV02 = z.infer<typeof ExposurePolicyV02>;
 ...
 */
export function allowAnalytical(policy: ExposurePolicyV02): boolean {
